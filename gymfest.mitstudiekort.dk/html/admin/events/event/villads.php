...
<body>
  ...
  <header class="header">
    ...
    <nav class=" nav">
      ...
      <div class="portal-info-mobile">
        ...
        <a class="button button-primary alert-leave d-print-none" style="width:auto;" href="/student/">
          Gå til Student
        </a>
                        ...
                        <div class="mt-2" style="display: flex; flex-direction:column;">
                          ...
                          <div class="form-group" style="max-width: 25rem;">
                            ...
                            <input class="form-input mb-4" id="ticket-price" value="<?php echo $price?>"
                              name="ticket-price" type="number" />
                            <button class="button button-secondary mb-4" style="width:100%;" data-module="modal"
                              data-target="location-modal">
                              Vælg nyt sted <svg class="icon-svg" focusable="false" aria-hidden="true">
                                <use xlink:href="#location-on"></use>
                              </svg>
                            </button>
                          </div>
                        </div>
                    ...
                    <div class="row bg-violet p-5">
                      <div class="col-12 align-text-left">
                        <button class="button button-primary alert-leave d-print-none my-2"
                          style="width: 100%; margin-left:0" onclick="handleEdit()">
                          Gæm ændringer
                        </button>
      ...
      <div class="fds-modal" id="location-modal" aria-hidden="true" role="dialog" aria-modal="true"
        ...
        <div class="modal-content" style="height:50%; width:80%;">
          ...
          <div class="modal-footer">
            <button class="button button-primary" id="save-edit-button" data-modal-close="" onclick="updateMap()">Gem
              placering</button>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.1/locale/da.min.js"
    integrity="sha512-rybyYvSnwg3zAZ/vjTTMoh8tOK0Z6tC2XCzr9e27M0xr8WU40IGo6SOP7FXXCyWgMyd3wZ8ln2nY4ce1ysYUfw=="
    crossorigin="anonymous"></script>
  ...
  <script>
    $('document').ready(function () {
      console.log(moment.tz(moment.unix( <?php echo $startDate ?> ), "Europe/Copenhagen").format("l LT"));
      date1 = flatpickr("#event-start-date", {
        ...
        defaultDate: moment.tz(moment.unix( <?php echo $startDate ?> ), "Europe/Copenhagen").format("l LT")
        //defaultMinute: moment.tz(moment.unix( ), "Europe/Copenhagen").format('m'),

      });
      console.log(moment.tz(moment.unix( <?php echo $endDate ?> ), "Europe/Copenhagen").format("l"));
      date2 = flatpickr("#event-end-date", {
        ...
        time_24hr: true,
        dateFormat: "d-m/Y H:i",
        defaultDate: moment.tz(moment.unix( <?php echo $endDate ?> ), "Europe/Copenhagen").format("l LT")
      });
  ...
  <script>
    const validateForm = () => {
      ...
      if (eventName.length > 0 && startTime.length > 0 && endTime.length > 0 && ticketAmount.length > 0 &&
        invitedClasses.length > 0 && typeof (latSave) !== undefined && typeof (lngSave) !== undefined) {
    ...
    function handleEdit() {
      ...
      if (validateForm()) {
        ...
        $("#save-edit-button").html(
          '<div style = "margin-inline-start: 67px; margin-inline-end: 67px; font-size:6px;" class="spinner-white"> </div>'
        );
        delta = delta.replace("&", "§€§€");
        console.log(eventName, startTime, endTime, publishAt, price, delta, lattitude, longitude);
        ...
        xhttp.send("se=" + startTime + "&ee=" + endTime + "&en=" + eventName + "&pe=" + publishAt + "&p=" + price +
          +"&d=" + delta + "&lng=" + lattitude + "&lat=" + longitude);
      }
    }
  </script>
</body>