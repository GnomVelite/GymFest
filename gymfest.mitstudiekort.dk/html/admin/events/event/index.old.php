  ...
  <main class="container page-container" style="padding-left: 0; padding-right: 0; max-width: none">
    <div class="event-fader col-lg-12 col-md-12 col-sm-12 mb-2" style="max-width: none; background: rgb(255,255,255); background: linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(242,241,241,1) 100%); padding:none;">
      <div class="event-header col-lg-10 offset-lg-1 col-md-10 offset-md-1 col-sm-12">
        <img src="/assets/rave-example-photo.jpg" class="mx-auto" style="width: 80%; height:350px; object-fit: cover; border-radius: 30px; display: block;" alt="Dit event foto">
        <div class="mx-5 py-5" style="display: flex; width: 80%; margin-left: 10% !important; flex-direction:row; justify-content: space-between; align-items: center;">
    ...
    <div class="event-body col-lg-10 offset-lg-1 col-md-10 offset-md-1 col-sm-12">
      <div class="row pl-md-6 px-6 pt-4">
        <div class="col-lg-8 col-md-7 ml-md-4 mb-4" style="border-radius: 10px; background-color: #f9f9f9; box-shadow: 0 2px 4px 0 rgba(0,0,0,0.2); text-align: left;">
          <div class="pb-4">
            <h3 style="background-color: #f9f9f9; color:black;" class="my-4">Detaljer</h3>
            <div class="mt-4" style="display: flex; flex-direction:row; align-items:center;">
              ...
              <div style="display: flex; flex-direction:column;">
                <h5 style="background-color: #f9f9f9; color:black;" class="mt-2 ml-2 row"> Pris pr. billet: <span
                    style="font-weight: 400; padding-left: 4px;"><?php echo $price." kr." ?> </span></h5>
              </div>
            </div>
            <div class="mt-4" style="display: flex; flex-direction:row; align-items:center;">
              <div style="height: 3rem; width:3rem;">
              ...
              <div style="display: flex; flex-direction:column;">
                <h5 style="background-color: #f9f9f9; color:black;" class="mt-2 ml-2"> Antal billetter: <span
                    style="font-weight: 400;"><?php echo $tickets ?> </span></h5>
              </div>
            </div>
            <!-- Hvis der er en offentliggøringsdato sat-->
            <?php setlocale(LC_ALL, 'da_DA'); if($publishDate != null){echo '<div class="mt-4" style="display: flex; flex-direction:row; align-items:center;"><div style="height: 3rem; width:3rem;"><svg style="width:100%; height:100%;" class="icon-svg" focusable="false" aria-hidden="true"><use xlink:href="#clock"></use></svg></div><div style="display: flex; flex-direction:column;"><h5 style="background-color: #f9f9f9; color:black;" class="mt-2 ml-2"> Offentligøres den: <span style="font-weight: 400;">'.strftime("%d %B %Y %R", $publishDate).'</span></h5></div></div>';} ?>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 ml-md-6 mb-md-4" style="border-radius: 10px; background-color: #f9f9f9; box-shadow: 0 2px 4px 0 rgba(0,0,0,0.2); text-align: left;">
          <div class="pb-4">
            <h3 style="background-color: #f9f9f9; color:black;" class="my-4">Event indstillinger</h3>
