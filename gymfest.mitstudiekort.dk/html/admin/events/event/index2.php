...
<body>
    ...
    <div class="portal-header ">
      <div class="container portal-header-inner">
        ...
        <div class="portal-info">
          ...
          <a class="button button-secondary alert-leave d-print-none" href="#">
            Log af
          </a>
        </div>
      </div>
    ...
    <nav class=" nav">
      ...
      <!-- 3: Main navigation-->
        ...
        <div class="portal-info-mobile">
          ...
          <a href="#" class="button button-secondary button-signout alert-leave">
            Log af
          </a>
        </div>
  ...
  <main class="container page-container">
    <div class="card card-align-height pb-4">
      <div class="card-content" style="background-color:#F3F4F6;">
        <div class="content">
          <div class="row">
            <div class="col-12" style="position: relative;">

              <img src="/assets/rave-example-photo.jpg" style="width: 100%; height:500px; object-fit: cover;"
                alt="Dit event foto">

              <div class="py-lg-4 py-5"
                style="text-align:center; background-color:white; opacity: 0.90; width:100%; position: absolute; bottom: 7px; left: 16px;">
                <p class="h2 ml-4" style=" text-align: start;"><?php echo $eventName ?></p>

              </div>
              <div style="position: absolute; bottom: 13px; left: 225px;">
                <div style="display: flex; flex-direction:row; align-items:center;">
                  ...
                  <div style="display: flex; flex-direction:column; text-align:left;">
                    <h5 class="mt-2"> Start tidspunkt: <span style="font-weight: 400;"> <?php echo $startDate ?> </span>
                    </h5>
                    <h5 class="mt-2"> Slut tidspunkt: <span style="font-weight: 400;"><?php echo $endDate ?> </span>
                    </h5>
                  </div>
                </div>
              </div>
          ...
          <div class="row pl-md-6 px-6 pt-4">
            <div class="col-lg-8 col-md-7 ml-md-4 mb-4"
              style="border-radius: 10px; background-color: #F9FAFB; box-shadow: 0 2px 4px 0 rgba(0,0,0,0.2); text-align: left;">
              <div class="pb-4">
                <h3 style="background-color: #F9FAFB; color:black;" class="my-4">Detaljer</h3>
                ...
                <div class="mt-4" style="display: flex; flex-direction:row; align-items:center;">
                  ...
                  <div style="display: flex; flex-direction:column;">
                    <h5 style="background-color: #F9FAFB; color:black;" class="mt-2 ml-2"> Pris pr. billet: <span
                        style="font-weight: 400;"><?php echo $price ?> </span></h5>
                  </div>
                </div>
                ...
                <div class="mt-4" style="display: flex; flex-direction:row; align-items:center;">
                  ...
                  <div style="display: flex; flex-direction:column;">
                    <h5 style="background-color: #F9FAFB; color:black;" class="mt-2 ml-2"> Antal billetter: <span
                        style="font-weight: 400;"><?php echo $tickets ?> </span></h5>
                  </div>
                </div>

                <!-- Hvis der er en offentliggøringsdato sat-->
                <?php if($publishDate != null){echo '<div class="mt-4" style="display: flex; flex-direction:row; align-items:center;"><div style="height: 3rem; width:3rem;"><svg style="width:100%; height:100%;" class="icon-svg" focusable="false" aria-hidden="true"><use xlink:href="#clock"></use></svg></div><div style="display: flex; flex-direction:column;"><h5 style="background-color: #F9FAFB; color:black;" class="mt-2 ml-2"> Offentligøres den: <span style="font-weight: 400;">'.$publishDate.'</span></h5></div></div>';} ?>

              </div>
            </div>
            <div class="col-lg-3 col-md-4 ml-md-6 mb-md-4"
              style="border-radius: 10px; background-color: #F9FAFB; box-shadow: 0 2px 4px 0 rgba(0,0,0,0.2); text-align: left;">
              <div class="pb-4">
                <h3 style="background-color: #F9FAFB; color:black;" class="my-4">Event indstillinger</h3>
                <a class="button button-primary alert-leave d-print-none my-2" style="width: 100%;" href="#">
                  Rediger detajer
                </a>
