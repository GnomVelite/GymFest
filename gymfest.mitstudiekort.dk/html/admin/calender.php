...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="calender.module.css" />
...
<body>
  ...
  <main class="container page-container">
    <div class="row justify-center">
      <div class="col-lg-6 col-sm-12" style="width: 100%;"></div>
      <div class="col-lg-6 col-sm-12 fc-theme-lux" id='calendar'></div>
    </div>
