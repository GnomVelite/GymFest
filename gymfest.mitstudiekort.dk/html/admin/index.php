...
<head>
  ...
  <style>
    ...
    a:visited.fc-daygrid-event.fc-daygrid-dot-event.fc-event.fc-event-start.fc-event-end.fc-event-future{
      text-decoration: none;
      color: #0059B3 !important;
    }
    a:visited.fc-daygrid-event.fc-daygrid-dot-event.fc-event.fc-event-start.fc-event-end.fc-event-past{
      text-decoration: none;
      color: #0059B3 !important;
    }
...
<body>
      ...
      <div class="navbar navbar-primary">
        ...
        <div class="navbar-inner container">
          <ul class="nav-primary">
            ...
            <li>
              <a href="opret" class="nav-link" title="Min profil">
                <span>Opret begivenhed</span>
              </a>
            </li>
            <li>
              <a href="events" class="nav-link" title="Fester">
  ...
  <main class="container page-container">
    <div class="row justify-center">
      <div class="col-12 fc-theme-lux" id='calendar'></div>
    </div>
...
<script>
  function renderCalender() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      events: {
        url: 'https://gymfest.mitstudiekort.dk/api/onsite/event/fetchEventsBetween.php?',
        method: 'POST',
      },
    });
