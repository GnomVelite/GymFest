...
<body>
    ...
    <main class="container page-container" style="padding-right: 0; padding-left: 0; margin-top: 150px;">
        <div class="card-signin">
            <div class="row logo"></div>
            <div class="row justify-content-center mb-2">
                <div class="col-12">
                    <div class="h2" style="text-align: center; margin-top: 6.2rem"> – Log på – </div>
                </div>
                <div class="col mx-auto">
                    <div class="form-group">
                        <label class="form-label " style="font-weight: 300; line-height:0;" for="email">
                            Email
                        </label>
                        <input class="form-input mb-5" id="email-input" placeholder="eksempel@mail.dk" name="email" style="max-width: none;" type="text">
                        <label class="form-label " style="font-weight: 300; line-height:0;" for="Kodeord">
                            Kodeord
                        </label>
                        <input class="form-input mb-5" id="password" value="" name="pass" style="max-width: none;" type="password">
                        <div style="text-align: center!important;"><button class="button button-primary" onclick="handleLogin();">Login</button></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    function handleLogin() {
        ...
        var data = "{\"username\":\""+username+"\", \"password\":\""+password+"\", \"service\": 1}";
        ...
        if(this.readyState === 4) {
           // console.log(this.responseText);
            ...
            if(output["status"] == "OK") {
                ...
                window.location.replace("https://gymfest.mitstudiekort.dk/api/onsite/auth/handleAuth?t="+token+"&ac=login");
            }
        }
        });

        xhr.open("POST", "https://mitstudiekort.dk/api/offsite/auth/validateServiceLogin.php");
