...
$time = time();
$sql = "UPDATE users SET `passwordKey` = UUID(), emailDate = '".($time)."' WHERE `id` = '".($id)."'";
if (!$conn->query($sql)) { // opdater email data
  echo "notkeyUpdated";
}
$userSql = "SELECT firstName, lastName, email, passwordKey FROM users WHERE `id` = '".($id)."'";
...
//email setup
$to = $email;
$subject = 'Ændring i oplysninger – Mit Studiekort';
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; width: 100%;" width="100%">
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                        ...
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Du modtager denne mail, da du har forsøgt at ændre dine loginoplysninger på mit studiekort. For at vi kan opdaterer dine oplysninger skal du indtaste følgende kode på hjemmesiden.</p>
                            ...
                            <tr>
                              <td align="center" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;" valign="top">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: auto; width: auto;">
                                  <tbody>
                                    <tr>
                                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; border-radius: 5px; text-align: center; background-color: #ec0867;" valign="top" align="center" bgcolor="#ec0867"> <a href="https://www.mitstudiekort.dk/api/onsite/auth/handlePasswordChange.php?key='.$key.'" target="_blank" style="border: solid 1px #ec0867; border-radius: 5px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-decoration: none; text-transform: capitalize; background-color: #ec0867; border-color: #ec0867; color: #ffffff;">Tryk her!</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
                        ...
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Hvis det ikke er dig der har anmodet om at ændre dine login oplysninger, bør du ændre både email og password på mit studiekort</p>
