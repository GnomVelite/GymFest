...
$barcodesql = "SELECT firstName, lastName, email, emailVerifiedAt FROM users WHERE `id` = '".($id)."'";
...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="/dashboard/mycard.module.css" />
...
<body>
  ...
  <header class="header">
    ...
    <div class="portal-header ">
      <div class="container portal-header-inner">
        <a href="javascript:void(0);" title="Hjem" class="logo alert-leave">
        </a>
      ...
      <div class="navbar navbar-primary">
        ...
        <div class="navbar-inner container">
          <ul class="nav-primary">
            ...
            <li>
              <a href="/dashboard/settings.php" class="nav-link" title="Se dine oplysninger">
  ...
  <main class="container page-container" style="padding-top:0;">
    ...
    <section class="my-services">
      <h1 class="mt-6 mt-md-7">Mine tjenester</h1>
      <p class="font-lead">Her er et overblik over de tjenester du har adgang til med Mit Studiekort</p>
      <div class="row">

        <div class="col-12 col-sm-6 col-md-4 col-lg-4 pb-4">
          <div class="card card-align-height">
            <div class="card-header" style="display: flex; align-items:center; justify-content:space-between; ">
              <a style="text-decoration:none" href="https://gymfest.mitstudiekort.dk/"><p class="h4">GymFest</p></a>
             <a href="https://gymfest.mitstudiekort.dk/"> <img style="height: 50px; width: 50px;" src="../assets/gymfest-logo.svg" alt="gymfest-logo" /> </a>
            </div>
            <div class="card-content bg-alternative py-4">
              <div class="content">
                <div class="row justify-content-center">
                  <div class="col-12">
                  <a style="text-decoration:none" href="https://gymfest.mitstudiekort.dk/"><p>Køb, administrer og se dine billetter til dine gymnasie arrangementer </p></a>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-footer" style="padding: 20px; display: flex; justify-content:space-evenly !important; ">
              <a class="button button-primary alert-leave d-print-none" href="https://gymfest.mitstudiekort.dk/">
                Gå til GymFest
              </a>
            </div>
          </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-4 pb-4">
          <div class="card card-align-height bg-alternative">
            <div class="card-header bg-alternative"
              style="height: 82px; display: flex; align-items:center; justify-content:space-between; ">
              <p class="h4">Kommer snart</p>
            </div>
            <div class="card-content bg-alternative py-4">
              <div class="content">
                <div class="row justify-content-center">
                  <div class="col-12">
                    <p alt="som om!">Vi arbejder hver dag for at gøre Mit Studiekort bedre! </p>
                  </div>
                </div>
              </div>
            </div>
