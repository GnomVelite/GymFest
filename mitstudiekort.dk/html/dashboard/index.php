...
<body>
        ...
        <div class="row justify-content-center mb-2">
            ...
            <div class="col-sm-8 mx-auto">
                <div class="virtualCard">
                    <div class="row">
                        <?php 
                            $datessql = "SELECT pictureid FROM cards WHERE `ownerid` = '".($id)."'";
                            $result3 = $conn->query($datessql);
                        ...
                        ?>
                        <div class="col-lg-auto col-auto mx-auto avatar" style="width: 150px; height: 150px; background-image: url(<?php echo $pid; ?>); background-size: cover; background-position: center;">
                            <!--<img src="<?php echo $pid ?>" class="avatar" style="width: 150px; height: 150px;" alt="">-->
                    ...
                    <div class="row">
                        <div class="col-8 mx-auto" style="text-align: center">
                            ...
                            <p class="school"><?php echo $_SESSION["schoolname"];?></p>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row" style="margin-top:15px;margin-left:5px">
                        <div class="col-8">
                            <?php 
                            $datessql = "SELECT birthdate, expiry  FROM cards WHERE `ownerid` = '".($id)."'";
                            $result2 = $conn->query($datessql);
                            if ($result2->num_rows > 0) {
                                ...
                                echo "<b>Fødselsdag: </b>".$bTime->format('m/d-Y')."<br><b>Udløbsdato: </b>".$exTime->format('m/d-Y');
                            } else {
                                $exEpoch = "";
                                $bEpoch = "";
                                echo "<b>Fødselsdag: </b><br><b>Udløbsdato: </b>";
                            }
                    ...
                    <div class="row">
                        <div class="col-12" style="text-align:center;position: relative;">
                            <p style="color:#656565;position:absolute;">UUID: AA-BB-11-22</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    var qrcode = new QRCode(document.getElementById("qrcode"), {
        text: "<?php echo $_SESSION["barcode"] ?>",
        width: 256,
        height: 256,
        colorDark : "#000000",
        colorLight : "#e3e3e3",
