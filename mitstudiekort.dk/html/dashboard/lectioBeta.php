<?php
    ...
    if(strlen($studentName) > 0 && strlen($schoolName) > 0 && strlen($imageUrl) > 0 && strlen($gymcode) > 0){
      $check = 1;
    }

    // echo("<img src='/dashboard/cardstore/users/".$username.".png'>");
    $resultArray = array($studentName, $schoolName, $cardstoreref, $gymcode, $check);
