...
/*if (!isset($_SESSION['barcode'])) {
    echo "Du mangler et fucking kort!";
}*/

$barcodesql = "SELECT firstName, lastName, email, barcode FROM users WHERE `email` = '".($email)."'";
...
<body>
    ...
    <div class="hide-base-svg">
        <svg xmlns="http://www.w3.org/2000/svg">
            ...
            <symbol id="sort-none" viewBox="0 0 24 24">
                <g fill="none" fill-rule="evenodd">
                    <path d="M0 0h24v24H0z" />
                    <path d="M7.207 13.5L12 18.293l4.793-4.793H7.207zm9.586-3L12 5.707 7.207 10.5h9.586z"
                        stroke="#1A1A1A" />
                </g>
            </symbol>
    ...
    <main class="container page-container">
        <div class="mb-2">
            <h2 style="text-align: left; margin: 0px">Digitalisér dit studiekort</h2>
            <h3 style="text-align: left; margin: 0px;margin-top: 5px; color:rgba(0, 0, 0, 0.7)">Hvem er du?</h3>
            <div class="overflow-menu  overflow-menu--open-right ">
                <button class="button-overflow-menu js-dropdown " data-js-target="overflow5" aria-haspopup="true"
                    aria-expanded="false">
                    Trin 1 af 3
            ...
            <form>
                ...
                <div class="form-group">
                    ...
                    <input class="form-input " id="navn" value="" name="navn" type="text">
                </div>
                <!-- Felt slut: Fornavn -->
                ...
                <div class="form-group">
                    <label class="form-label " for="navn">
                        Efternavn(e)
                        <button class="popover js-tooltip button-unstyled" data-tooltip-trigger="click"
                            data-tooltip-position="top" aria-label="Klik på ikon for tooltip"
                            data-tooltip="Dette inkluderer samtlige efter- og mellemnavne.">
                            <svg class="icon-svg" style="height:22px" focusable="false" aria-hidden="true">
                ...
                <div class="form-group ">
                    ...
                    <label class="form-label " for="options">Dit gymnasie (vælg)</label>
                    <select class=" form-select" name="options" id="options">
                        <option value>Vælg</option>

                        <option value="school-1">H.C. Ørsted Gymnasiet</option>

                        <option value="school-2">Virum Gymnasium</option>

                        <option value="school-3">Nærum Taberne</option>
                ...
                <div class="form-group">
                    <label class="form-label " for="birthdate">
                        Din fødselsdato (vælg)
                    </label>

                    <div class="date-picker"><input class="form-input " required id="birthdate" value=""
                            name="birthdate" type="text"></div>
                </div>
                <!-- Felt slut: Alder -->
